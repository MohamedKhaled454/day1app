        ...
        <div className=" text-center text-light w-100 h-100  d-flex flex-column justify-content-center align-items-center p-5 gap-4">
          ...
          <div className="d-flex w-100  justify-content-center align-items-center">
            ...
            <div className=" w-100  ">
              ...
              <ProgressBar text="Html5" value="80"></ProgressBar>
              <ProgressBar text="ES6" value="70"></ProgressBar>
              <ProgressBar text="Css3" value="80"></ProgressBar>
              <ProgressBar text="Node js" value="60"></ProgressBar>
              <ProgressBar text="React" value="50"></ProgressBar> 
